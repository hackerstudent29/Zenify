...
class ApiClient {
  ...
  ApiClient() {
    final rawApiUrl = dotenv.env['NEXT_PUBLIC_API_URL'] ?? 'https://zenify-production-111f.up.railway.app/api';
    // Set baseUrl to the domain origin without '/api' suffix (e.g. 'https://zenify-production-111f.up.railway.app')
...
String getProxiedAudioUrl(String? path) {
  ...
  final apiUrl = dotenv.env['NEXT_PUBLIC_API_URL'] ?? 'https://zenify-production-111f.up.railway.app/api';
