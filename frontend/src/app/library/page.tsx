                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-8 gap-5">
                          {overview.recentAlbums.map((album: any) => (
                            ...
                            >
                              ...
                              <div className="px-1">
                                <h3 className="font-bold text-[12px] truncate group-hover:text-accent transition-colors">
                                  {album.title}
                                </h3>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-8 gap-5">
                    ...
                    {playlists.map((playlist: any) => (
                      ...
                      >
                        ...
                        <div className="px-1">
                          <h3 className="font-bold text-[12px] truncate group-hover:text-accent transition-colors text-foreground">
                            {playlist.name}
                          </h3>
                          <p className="text-[10px] text-zinc-500 font-medium truncate mt-0.5">
                            {playlist._count?.tracks || 0} tracks
                ...
                {isLoadingAlbums ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-32 text-center">
                    ...
                    <Button
                      ...
                      className="font-bold uppercase tracking-wider text-xs bg-rose-500 text-white hover:bg-rose-600"
                    >
                      Import Music
                    </Button>
                  </div>
