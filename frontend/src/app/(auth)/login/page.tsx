                            ...
                            >
                                <div className="space-y-2">
                                    ...
                                    <p className="text-[10px] uppercase tracking-widest text-[var(--muted)] font-bold">
                                        {resetStep === 'request' ? "Enter your email to receive an OTP" : "Enter the code sent to your email"}
                                    </p>
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    {resetStep === 'verify' && (
                                        <>
                                            <div className="space-y-2">
                                                <label className="text-[10px] font-bold uppercase tracking-widest text-[var(--muted-dark)] ml-1">Security Code</label>
                                                <input
                                                    type="text"
                                                    value={otp}
                                                    ...
                                                    maxLength={6}
                                                    required
                                                    className="w-full bg-surface-hover/40 rounded-xl px-5 py-4 text-sm text-foreground text-center tracking-[1em] font-bold placeholder:text-muted-dark focus:outline-none focus:bg-surface-hover/80 transition-all shadow-sm"
                                                />
                                            </div>
                                            <div className="space-y-2">
                                                <label className="text-[10px] font-bold uppercase tracking-widest text-[var(--muted-dark)] ml-1">New Password</label>
                                                <input
                                                    type="password"
                                                    value={password}
                                ...
                                <div className="space-y-3">
                                    <button
                                        type="submit"
                                        disabled={isLoading}
                                        className="w-full bg-[var(--accent)] text-white font-bold py-4 rounded-xl text-xs uppercase tracking-[0.2em] hover:brightness-110 active:scale-[0.98] transition-all disabled:opacity-70 shadow-2xl shadow-[var(--accent)]/20 cursor-pointer"
                                    >
                                        {isLoading ? "Loading..." : (resetStep === 'request' ? "Send Code" : "Reset Password")}
                                    </button>
                                    <button
                                        type="button"
                                        onClick={() => setShowForgotPassword(false)}
                                        className="w-full text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--muted)] hover:text-white transition-colors"
                                    >
                                        Back to Login
                                    </button>
                                </div>
                                        ...
                                        <div className="flex justify-between items-center px-1">
                                            ...
                                            {activeTab === 'login' && (
                                                <span
                                                    ...
                                                    className="text-[10px] font-bold uppercase tracking-widest text-[var(--accent)] hover:text-[var(--accent)]/80 cursor-pointer transition-colors"
                                                >
                                                    Forgot?
                                                </span>
                                            )}
