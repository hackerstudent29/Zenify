...
export default function AuthPage() {
 ...
 className="w-full h-11 flex items-center justify-center rounded-lg bg-zinc-900 hover:bg-zinc-900 text-[13px] font-bold text-brand transition-all shadow-lg shadow-brand/10 disabled:opacity-50 mt-4">
 ...
 <button type="submit" disabled={isLoading}
 className="w-full flex items-center justify-center rounded-lg bg-zinc-900 hover:bg-zinc-900 py-2.5 text-[13px] font-medium text-brand transition-colors disabled:opacity-50">
 ...
 <button type="submit" disabled={isLoading}
 className="w-full flex items-center justify-center rounded-lg bg-zinc-900 hover:bg-zinc-900 py-2.5 text-[13px] font-medium text-brand transition-colors disabled:opacity-50 active:scale-[0.98]">
