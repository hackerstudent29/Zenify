...
export default function AboutPage() {
 ...
 className="w-full h-full object-cover transition-all duration-700 group-hover:grayscale-0 group-"
 />
 ...
 target="_blank"
 rel="noreferrer"
 className="w-11 h-11 rounded-2xl bg-white/[0.05] border border-white/10 flex items-center justify-center text-brand/40 hover:text-brand hover:bg-zinc-900/10 hover:border-brand/30 transition-all active:scale-90 group/insta"
 >
