...
export const CoverCropModal = memo(function CoverCropModal({
 ...
 <button onClick={() => setScale(1)} title="Reset zoom" className="shrink-0 w-5 h-5 rounded-md hover:bg-zinc-900/10 flex items-center justify-center text-brand/20 hover:text-brand transition-colors">
 <RefreshCw size={9} />
 </button>
 ...
 <button onClick={() => setRotate(0)} title="Reset rotation" className="shrink-0 w-5 h-5 rounded-md hover:bg-zinc-900/10 flex items-center justify-center text-brand/20 hover:text-brand transition-colors">
 <RefreshCw size={9} />
 </button>
