...
export function NotificationListener() {
 ...
 const connectSSE = () => {
 const sseUrl = `${(import.meta.env.VITE_API_URL || import.meta.env.NEXT_PUBLIC_API_URL) || 'https://zenify-production-7f21.up.railway.app/api'}/notifications/stream?token=${encodeURIComponent(accessToken)}`;
