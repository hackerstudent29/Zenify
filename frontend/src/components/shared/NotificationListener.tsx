...
export function NotificationListener() {
    ...
    useEffect(() => {
        ...
        const connectSSE = () => {
            const sseUrl = `${import.meta.env.NEXT_PUBLIC_API_URL || 'https://zenify-production-08b4.up.railway.app/api'}/notifications/stream?token=${encodeURIComponent(accessToken)}`;
