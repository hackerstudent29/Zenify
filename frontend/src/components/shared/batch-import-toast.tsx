            ...
            {isBatchImporting && (
                ...
                >
                    <div className="flex items-center gap-4 mb-4">
                        <ZenLoading size="xs" className="text-rose-500 shrink-0" />
                        <div className="flex-1 min-w-0">
                            <h2 className="text-[12px] font-black tracking-tighter text-rose-500 uppercase italic truncate">Syncing collection</h2>
                            <p className="text-white/40 text-[9px] font-bold tracking-widest truncate">
                                {batchProgress.activeTrack || "Initializing..."}
                            </p>
                        </div>
                        <span className="text-[10px] font-black text-rose-500/60 tracking-[0.2em] shrink-0">
