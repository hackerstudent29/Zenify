        ...
        <section className={cn("space-y-4", className)}>
            <div className="flex items-end justify-between">
                <div className="space-y-1">
                    <h2 className="text-lg md:font-brand font-bold tracking-tight text-foreground/95">{title}</h2>
            ...
            <div className="relative group/scroll">
                <div
                    ...
                    className="flex gap-2 overflow-x-auto pb-6 no-scrollbar scroll-smooth snap-x snap-mandatory"
                >
                    {items.map((item, index) => (
                        <MediaCard
                            ...
                            index={index}
                            contextTracks={items}
                            className="w-[180px] sm:w-[200px] md:w-[210px] lg:w-[220px] xl:w-[230px] flex-shrink-0 snap-start"
                        />
                    ))}
                    {/* Padding at end */}
