    ...
    return (
        <>
            <motion.div
                ...
                className={cn(
                    "group relative flex flex-col gap-1 p-2 rounded-2xl transition-all duration-500 cursor-pointer hover:bg-white/[0.03]",
                    className
                )}
                onClick={(e) => {
                    e.stopPropagation();
            ...
            >
                ...
                <motion.div
                    ...
                    className="group/art relative aspect-square w-full rounded-2xl overflow-hidden bg-surface-hover shadow-xl"
                >
                    <img
