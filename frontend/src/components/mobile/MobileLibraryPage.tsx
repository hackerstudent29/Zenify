...
export function MobileLibraryPage({ 
 ...
 return (
 <div className="min-h-screen bg-background pb-[180px] pt-[80px]">
 {/* Mobile Library Header */}
 <div className="sticky top-[60px] z-40 bg-background/95 backdrop-blur-2xl border-b border-white/5 pt-5 pb-3 px-4">
