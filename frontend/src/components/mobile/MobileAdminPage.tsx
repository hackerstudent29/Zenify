...
export function MobileAdminPage() {
 ...
 return (
 <div className="min-h-screen bg-[#0a0a0b] pb-[200px] pt-[80px]">
 {/* Header */}
 <div className="sticky top-[60px] z-40 bg-background/95 backdrop-blur-2xl pt-6 pb-4 px-4 border-b border-white/5">
