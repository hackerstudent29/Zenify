...
export function SubscriptionSection() {
 ...
 className="px-6 py-2.5 bg-white/10 text-brand border border-white/5 hover:bg-white/20 rounded-xl font-bold text-[11px] uppercase tracking-wider transition-all shadow-lg"
 >
